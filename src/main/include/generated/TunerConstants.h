...
class TunerConstants {
    ...
    static constexpr configs::Slot0Configs steerGains = configs::Slot0Configs{}
        .WithKP(85).WithKI(0).WithKD(0.1)
        .WithKS(0.099660375).WithKV(1.50).WithKA(0)
    ...
    static constexpr std::string_view kCANBusName = "Marty the CANivore";
...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 4.53_mps; // TODO: update free speed
...
private:
    ...
    static constexpr units::scalar_t kDriveGearRatio = 6.821052631578947;
...
private:
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = -0.113525390625_tr;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = -0.29150390625_tr;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = 0.003662109375_tr;
    ...
    static constexpr int kBackRightSteerMotorId = 15;
    static constexpr int kBackRightEncoderId = 3;
    static constexpr units::turn_t kBackRightEncoderOffset = -0.19580078125_tr;
